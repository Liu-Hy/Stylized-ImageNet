...
IMAGENET_PATH = "/var/lib/data/imagenet/" # TODO specify ImageNet path
STYLIZED_IMAGENET_PATH = "/var/lib/data/stylized/" # TODO specify target path: where should Stylized-ImageNet be stored?
